!(function (e) {
  if (!e.JSBridge || !window.JSBridge.native) {
    ...
    (e.JSBridge = {
      onSuccess: function (e, t, r) {
        if (((r = void 0 === r ? 0 : r), '__iframe' === e.split('-')[r]))
          for (var n = 0; n < window.frames.length; n++)
            window.frames[n].postMessage({ xmmpMessage: { token: e, response: t, tokenParseCount: r + 1 } }, '*');
        else {
          if ('object' != typeof t)
            try {
          ...
          var o = 0;
          i[e] && (o = Date.now() - i[e]), console.log('客户端回调token:', e, o);
          try {
      ...
      on: function (e, t) {
        return (
          e && t && (window.JSBridge._event[e] || (window.JSBridge._event[e] = []), window.JSBridge._event[e].push(t)),
          this
        );
      },
      once: function (e, t) {
      ...
      _requestHybrid: function (t) {
        ...
        if ((console.log('客户端入参：', t), t.callback)) {
          var e = Date.now(),
            n = t.callbackName || 'token_' + e + '_' + Math.floor(1e4 * Math.random());
          i[n] = e;
          try {
            for (var o = window.self; o !== o.parent; ) (n = '__iframe-' + n), (o = o.parent);
          } catch (e) {}
    ...
    (this._initBody = function (e) {
      (this._bodyInit = e)
        ? 'string' == typeof e
          ...
          : support.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(e) || isArrayBufferView(e))
  ...
  (function (e, t) {
        ...
        [
          ...
          return new Promise(function (e) {
            function t() {
              ...
              2 === u &&
                ((e = s),
                window._VmCenter && window._VmCenter[e] && window._VmCenter[e].reload && window._VmCenter[e].reload());
            }
            var r = Date.now(),
    ...
    var c = {
      ...
      pageScrollTo: function (e) {
        if ((e.duration || (e.duration = 300), void 0 !== e.scrollTop)) t(e.scrollTop, e.duration);
        else if (e.selector) {
          if (void 0 === window.getComputedStyle(document.body).scrollBehavior)
            t(document.querySelector(e.selector).getBoundingClientRect().top, e.duration);
          else document.querySelector(e.selector).scrollIntoView({ behavior: 'smooth' });
        }
      },
      ...
      getLocation: function (e) {
        return (
          e && ((e.sdk = e.sdk || 0), (e.location = e.sdk || 0), (e.timeout = parseInt((e.timeout || 3e4) / 1e3))),
          l(f.getLocation, e)
        );
      },
      openFile: function (e) {
      ...
      getHWSSOString: function () {
        return (
          console.info('废弃通知：getHWSSOString即将废弃，请使用getAuthCode代替，请注意返回值的变化'),
      ...
      uploadFileToCloudDriver: function (e) {
        ...
        return !0 !== t
          ? t
          : (void 0 === e.chooseUploadPath && (e.chooseUploadPath = !0), l(f.uploadFileToCloudDriver, e));
      },
  ...
  window.addEventListener(
    ...
    function (e) {
      ...
      console.log('资源加载错误：', e),
        'link' === t
          ? window.xm && xm.native('dotlog', { key: 'RESOURCE#0', value: [location.href, e.target.href] })
          : 'script' === t || 'img' === t
          ? window.xm && xm.native('dotlog', { key: 'RESOURCE#0', value: [location.href, e.target.src] })
...
if (window.xm && isTv) {
  ...
  var pageMap = { red: { url: 'index.html#/page/tv-create/page-1604471484664', title: '发起红灯' } },
    tv = {
      screenshot: function () {
        return new Promise(function (t, e) {
          window.xm.hideLoading(),
            window.xm
              .native('screenshot', { x: 0, y: 0, width: window.screen.width, height: window.screen.height })
              .then(function (e) {
            ...
            window.xm.openApp({
              ...
              relativeUrl:
                ...
                encodeURIComponent(
                  JSON.stringify(
                    Object.assign(
                      { imgUrl: t, majorName: e.name, majorUid: String(e.uid), firstDepts: [], firstUsers: [] },
                      r,
                    ),
                  ),
                ),
